...
Public Class blocoSala
    ...
    Public Sub gribsala(sql As String)
        Call conectar()
    ...
    Private Sub DataGridBloco_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridBloco.CellContentClick
