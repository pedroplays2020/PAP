...
Public Class Registo
    ...
    Public Sub limparregisto()
        ...
        txtnomeutilizadoregisto.Clear()
        txtfuncaoregistos.Clear()
        txtUtilizador.Clear()
        txtcategoriaregisto.Clear()
    ...
    Private Sub btnnovoregisto_Click(sender As Object, e As EventArgs) Handles btnnovoregisto.Click
        ...
        txtUtilizador.Text = Grelha.CurrentRow.Cells(1).Value
    ...
    Private Sub Registo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtnomeutilizadoregisto.Enabled = False
        txtfuncaoregistos.Enabled = False
        txtcategoriaregisto.Enabled = False
    ...
    Private Sub comboturmaregistos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles comboturmaregistos.SelectedIndexChanged
