...
Module ligacaoBD
    ...
    Public ConnectionString_new As String = "Data Source=hp\espinho;Initial Catalog=Agenda;Integrated Security=True"
    ...
    Public Function conectar()
        con.Close()
        con.ConnectionString = "Data Source=hp\espinho;Initial Catalog=Agenda;Integrated Security=True"
        con.Open()
