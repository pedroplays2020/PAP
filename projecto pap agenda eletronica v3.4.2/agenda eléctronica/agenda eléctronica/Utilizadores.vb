...
Public Class Utilizadores
    ...
    Public Sub ler_sql()
        ...
        ElseIf txtuserfiltro.Text = "" And combotipofiltro.SelectedIndex = -1 And comboestadofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.nome = '" & txtnomedeutilizador.Text & "%'"
            consutilizador(sql)
        ...
        ElseIf txtuserfiltro.Text = "" And txtnomedeutilizador.Text = "" Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.estado = '" & comboestadofiltro.Text & "' t1.tipodeutilizador = '" & combotipofiltro.Text & "'"
            consutilizador(sql)
        ElseIf txtuserfiltro.Text = "" And combotipofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.estado = '" & comboestadofiltro.Text & "' and t1.nome = '" & txtnomedeutilizador.Text & "%''"
            consutilizador(sql)
        ElseIf txtuserfiltro.Text = "" And comboestadofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.nome = '" & txtnomedeutilizador.Text & "%' and t1.tipodeutilizador = '" & combotipofiltro.Text & "'"
            consutilizador(sql)
        ...
        ElseIf txtnomedeutilizador.Text = "" And comboestadofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where  t1.utilizador  '" & txtuserfiltro.Text & "%' and t1.tipodeutilizador = '" & combotipofiltro.Text & "'"
            consutilizador(sql)
        ElseIf combotipofiltro.SelectedIndex = -1 And comboestadofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.utilizador LIKE '" & txtuserfiltro.Text & "%' and t1.nome = '" & txtnomedeutilizador.Text & "%'"
            consutilizador(sql)
        ...
        ElseIf combotipofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.estado = '" & comboestadofiltro.Text & "' and t1.utilizador LIKE '" & txtuserfiltro.Text & "%' and t1.nome = '" & txtnomedeutilizador.Text & "%'"
            consutilizador(sql)
        ElseIf comboestadofiltro.SelectedIndex = -1 Then
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.estado = '" & comboestadofiltro.Text & "' and t1.utilizador LIKE '" & txtuserfiltro.Text & "%' and t1.nome = '" & txtnomedeutilizador.Text & "%'"
            consutilizador(sql)
        Else
            Dim sql As String = "select t1.idUtilizador, t1.utilizador, t1.nome, t1.tipodeutilizador, t1.estado, t1.morada, t1.codigoPostal, t1.codigoPostal2, t1.localidade, t1.telefone, t1.telemovel, t1.email, t1.dataNascimento, t2.Funcao, t3.nome, t1.obs, t1.chave from Utilizador t1 Inner Join Funcao t2 on (t1.idFuncao = t2.idFuncao) Inner Join AreaV t3 on (t1.idArea = t3.idArea) where t1.utilizador LIKE '" & txtuserfiltro.Text & "%' and t1.nome = '" & txtnomedeutilizador.Text & "%' and t1.tipodeutilizador = '" & combotipofiltro.Text & "'"
            consutilizador(sql)
        End If
    End Sub
