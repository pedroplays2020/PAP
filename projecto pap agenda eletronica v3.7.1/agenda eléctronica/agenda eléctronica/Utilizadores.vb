...
Public Class Utilizadores
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles Picturefoto.Click
        ...
        'If nome_foto <> "" Then
        '    Picturefoto.Image = System.Drawing.Bitmap.FromFile(nome_foto)
        'End If
        'MsgBox(nome_foto)
        ...
        Using Foto As New OpenFileDialog()
            ...
            If Foto.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
                ...
                Dim nome As String = Foto.FileName
                Picturefoto.Image = Image.FromFile(nome)
            End If
        End Using
...
End Sub
    ...
    Private Sub txthoraregistoutilizadores_TextChanged(sender As Object, e As EventArgs) Handles txthoraregistoutilizadores.TextChanged
    ...
    Private Sub txtregistutilizadores_TextChanged(sender As Object, e As EventArgs) Handles txtregistutilizadores.TextChanged
