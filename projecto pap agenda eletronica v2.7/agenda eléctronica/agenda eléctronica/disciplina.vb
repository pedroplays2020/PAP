...
Public Class Disciplina
    ...
    Private Sub txtnomedisciplina_TextChanged(sender As Object, e As EventArgs)
        Call conectar()
        Dim sql As String = "select * from Disciplina " & " where Nomedisciplina like '" & combareadisciplina.SelectedItem = -1 & "%'"
        Dim sqlcom As New SqlCommand(sql, con)
        Dim dr As SqlDataReader = sqlcom.ExecuteReader()
        Dim n As Integer = dr.FieldCount
        Dim i As Integer = 0
