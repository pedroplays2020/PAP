...
Public Class Utilizadores
    ...
    Public Sub consutilizador()
        Call conectar()
        Dim sql As String = "select idUtilizador,utilizador,tipodeutilizador,nome,morada,codigoPostal, codigoPostal2, localidade  from Utilizador"
    ...
    Private Sub btneliminarutilizador_Click(sender As Object, e As EventArgs) Handles btneliminarutilizador.Click
        ...
        Call conectar()
        Dim sql As String = " delete from Utilizador"
        Dim sqlcom As New SqlCommand(sql, con)
        Dim dr As SqlDataReader = sqlcom.ExecuteReader
        datagridutilizadores.Columns.Clear()
        Dim n As Integer = dr.FieldCount
