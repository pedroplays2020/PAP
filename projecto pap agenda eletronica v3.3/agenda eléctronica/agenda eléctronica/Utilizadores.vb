...
Public Class Utilizadores
    ...
    Public Sub consutilizador()
        Call conectar()
        Dim sql As String = "select idUtilizador, utilizador,nome, tipodeutilizador, estado from Utilizador"
    ...
    Private Sub btnguardarutilizadores_Click(sender As Object, e As EventArgs) Handles btnguardarutilizadores.Click
        ...
        If lblobrigatorioutilizadadores.Visible = False And lblobrigatorioutilzadorpassword.Visible = False And lblobrigatorioconfirmpasswordutilizadores.Visible = False And lblobrigatorioestadoutilizador.Visible = False And lblobrigatoriotipoutilizador.Visible = False And lblobrigatorionomeutilizador.Visible = False And lblobrigatoriomoradautilizador.Visible = False And lblobrigatoriocodigopostalocalidadeutilizadores.Visible = False And lblobrigatoriotelefonetelemovelutilizadores.Visible = False And lblobrigatorioemailutilizador.Visible = False And lblobrigatoriodatanascimentoutilizadores.Visible = False And lblobrigatoriofuncaoutilizador.Visible = False And lblobrigatoriocategoriautilizador.Visible = False Then
            If botao = 1 Then
                ...
                Call conectar()
                Dim sql As String = "insert into Utilizador values ('" & txtutilizadorutilizadores.Text & _
            ...
            ElseIf botao = 2 Then
                ' contarReg()
                Call conectar()
                Dim sql1 As String = "update Utilizador set utilizador, nome,  tipodeutilizador, estado = '" & txtnomedeutilizador.Text & "' where  idUtilizador = '" & txtnunutilizadores.Text & "'"
                ...
                lblobrigatorioestadoutilizador.Visible = False
                lblobrigatorioutilizadadores.Visible = False
                lblobrigatorioutilzadorpassword.Visible = False
                lblobrigatorionomeutilizador.Visible = False
                lblobrigatoriomoradautilizador.Visible = False
                lblobrigatoriotipoutilizador.Visible = False
                lblobrigatoriocodigopostalocalidadeutilizadores.Visible = False
                lblobrigatoriotelefonetelemovelutilizadores.Visible = False
                lblobrigatorioemailutilizadores.Visible = False
                lblobrigatoriodatanascimentoutilizadores.Visible = False
                lblobrigatoriofuncaoutilizador.Visible = False
                lblobrigatoriocategoriautilizador.Visible = False
                lblobrigatorioconfirmpasswordutilizadores.Visible = False
                lblobrigatorioemailutilizador.Visible = False
                'contarReg()
            End If
        End If
    ...
    Private Sub btneditarutilizadores_Click(sender As Object, e As EventArgs) Handles btneditarutilizadores.Click
        ...
        Else
            ...
            txtutilizadorutilizadores.Enabled = True
            txtnomeutilizadores.Enabled = True
            combotipoutilizadores.Enabled = True
            Comboestadoutilizadores.Enabled = True
            ' txtnomedeutilizador.Text = datagridutilizadores.CurrentRow.Cells(5).Value
...
End Sub
    ...
    Private Sub txtnomedeutilizador_TextChanged(sender As Object, e As EventArgs) Handles txtnomedeutilizador.TextChanged
        ...
        ' select idUtilizador, utilizador,estado,tipodeutilizador ,nome,morada, codigoPostal,codigoPostal2,localidade, telefone,telemovel, email, dataNascimento,idFuncao, idArea,  obs  from Utilizador"
    ...
    Private Sub grouputilizador_Enter(sender As Object, e As EventArgs) Handles grouputilizador.Enter
