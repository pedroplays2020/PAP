...
Public Class horario
    ...
    Public Sub consGrelha()
        ...
        Call desconectar()
    End Sub
    Public Sub carregarutilizador()
        Call conectar()
        Dim sql As String = "Select  U.idUtilizador, U.utilizador, U.nome, F.Funcao, A.nome from utilizador U, funcao F, areav A  where idUtilizador = '" & combonomehorario.SelectedValue & "' and U.idFuncao=F.idfuncao and U.idArea=A.idArea"
